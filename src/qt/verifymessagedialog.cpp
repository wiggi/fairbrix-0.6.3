    ...
    ui(new Ui::VerifyMessageDialog)
{
    ...
    ui->lnAddress->setPlaceholderText(tr("Enter a Fairbrix address (e.g. fLm4mKiGRjUJzvJZpmF74S7DUiJwhJwm9Q)"));
    ui->lnSig->setPlaceholderText(tr("Enter Fairbrix signature"));
#endif
